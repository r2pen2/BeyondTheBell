...
import { Navbar as NextUINavbar, Dropdown, Text, Col, Image, Button } from "@nextui-org/react";
...
function SchoolDaysIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height="30" viewBox="0 -960 960 960" width="30" fill="#f05c21">
...
function AfterSchoolIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height="30" viewBox="0 -960 960 960" width="30" fill="#f0214e">
...
function ContractIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height="30" viewBox="0 -960 960 960" width="30" fill="#009bdf">
    ...
    <NextUINavbar.Content hideIn="md" enableCursorHighlight activeColor="primary">
      <div className="d-flex flex-row align-items-center justify-content-end gap-2">
        <Button
          ...
          auto
          icon={<LocalPhoneIcon />}
          onClick={() => window.open("callto:5083164751")}
        />
        <Button
          light
          auto
          icon={<EmailIcon />}
          onClick={() => window.open("mailto:questions@beyondthebelleducation.com")}
        />
        <Button
          light
          auto
          icon={<LocationOnIcon />}
          onClick={() => window.open("https://goo.gl/maps/huC9JcTuWy1PebMP7", "_blank")}
        />
        <Button
          light
          auto
          icon={<FacebookIcon />}
          onClick={() => window.open("https://www.facebook.com/beyondthebelled/", "_blank")}
        />
      </div>
    </NextUINavbar.Content>
  )
